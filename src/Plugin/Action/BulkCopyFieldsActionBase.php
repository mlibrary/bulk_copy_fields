...
namespace Drupal\bulk_copy_fields\Plugin\Action;
 ...
 * )
 */
class BulkCopyFieldsActionBase extends ActionBase implements ContainerFactoryPluginInterface {
  /**
   * The plugin_id.
   *
   * @var string
  ...
  /**
   * Constructs a BulkCopyFields object.
   *
  ...
  public function executeMultiple(array $entities) {
    ...
    $this->tempStoreFactory->get('bulk_copy_fields_ids')
